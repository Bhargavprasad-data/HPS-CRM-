...
export default function AttendancePage() {
  ...
  const statCards = [
    { label: 'Present',      value: stats.present, icon: CheckCircle2, color: '#14b8a6', bg: 'rgba(20,184,166,0.1)',  border: 'rgba(20,184,166,0.2)' },
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <Clock size={18} strokeWidth={2} className="text-teal-400" />
            <h1 className="page-title">Attendance & Leaves</h1>
          </div>
          <p className="page-subtitle">Monitor team attendance and authorize leave requests</p>
        </div>
