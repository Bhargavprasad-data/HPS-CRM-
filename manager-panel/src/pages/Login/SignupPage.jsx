...
const BENEFITS = [
  ...
  { icon: Users,        text: 'Full team management access'       },
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-teal-200/70 text-base leading-relaxed mb-10">
            Register your manager account to access the premium workforce management portal.
          </p>
          ...
          <div className="space-y-3">
            {BENEFITS.map(({ icon: Icon, text }) => (
              <div key={text} className="flex items-center gap-3">
                ...
                <p className="text-teal-200/80 text-sm">{text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
              Fill in your details to join the HPS manager portal
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              <label className="relative cursor-pointer shrink-0">
                <div
                  ...
                  style={{
                    ...
                    border: `2px dashed ${photoPreview ? 'transparent' : 'rgba(13,148,136,0.3)'}`,
                  }}
                >
                  {photoPreview
              ...
              <div>
                ...
                <p className="text-xs mt-0.5" style={{ color: 'var(--text-secondary)' }}>
                  Click to upload · Max 2 MB · Optional
                </p>
                {photoPreview && (
                  <button
                    type="button"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Field label="Email Address *" icon={Mail}>
                <input className="input pl-10" type="email" placeholder="manager@hps.com" required
              ...
              <Field label="Designation" icon={Briefcase}>
                <input className="input pl-10" type="text" placeholder="Operations Manager"
