...
import {
  ...
  Clock, CheckCircle, Calendar, LayoutDashboard,
  ArrowRight, Shield
} from 'lucide-react';
import toast from 'react-hot-toast';

const FEATURES = [
  { icon: LayoutDashboard, label: 'Personal Dashboard',   desc: 'Real-time stats and quick actions'         },
  { icon: Clock,           label: 'Attendance Tracking',  desc: 'Clock in/out and view history'              },
  { icon: Calendar,        label: 'Leave Management',     desc: 'Apply and track leave requests'             },
  { icon: CheckCircle,     label: 'Project & Tickets',    desc: 'Stay on top of work and support tickets'    },
];
  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] relative overflow-hidden p-12"
        style={{ background: 'linear-gradient(135deg, #3b0764 0%, #1e1b4b 50%, #0c0a1e 100%)' }}
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-purple-200/70 text-base leading-relaxed mb-10">
            Manage attendance, leaves, projects and payslips — all from a single elegant dashboard.
          </p>
      ...
      >
        ...
        <div className="lg:hidden flex items-center gap-3 mb-10">
          ...
          <div>
            <p className="font-extrabold text-lg leading-none" style={{ color: '#3b82f6' }}>HPS</p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-2xl p-5 flex items-center justify-between"
            ...
            <div>
              <p className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>New employee?</p>
              <p className="text-xs mt-0.5" style={{ color: 'var(--text-secondary)' }}>Create your staff account</p>
            </div>
            <Link to="/signup"
